    ...
    return (
        ...
        >
            <Grid mt={2} container sx={{justifyContent: "center"}}>
                ...
                <Grid item xs={11}>
                    <Typography variant={'caption'}>Browse Balancer Contracts. Click on a contract to get more
                ...
                <Grid item xs={11} mt={1}>
                    <Typography variant={'caption'}>A list of all deployed contracts. Click on an item to get more
                        information.</Typography>
                </Grid>
